        ...
        <div className="relative p-6">
          <figure className="relative z-10">
            ...
            <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-emerald-500">
              ...
              <div className="flex items-center gap-4 pt-4 text-sm text-[#80BBFF]">
                <img
          ...
          >
            <path
              ...
              className="fill-[#80BBFF]/50"
            />
          </svg>
        </div>
      </div>
      {/*      <!-- End Elevated base sized testimonial with avatar and rating stars --> */}
    </>
  );
};
